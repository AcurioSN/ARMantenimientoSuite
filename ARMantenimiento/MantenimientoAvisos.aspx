<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MantenimientoAvisos.aspx.vb" Inherits="ARMantenimiento.MantenimientoAvisos" %>
...
.modal-footer {
    ...
    padding: 0.75rem 1.5rem;
		...
		<style>
			.postit-item {
			background-color: #fff8b0; /* amarillo Post-It por defecto */
			border-radius: 10px;
		...
		/* Colores por estado */
		.estado-1 { background-color: #fff8b0; } /* Pendiente de Atención */
		.estado-2 { background-color: #b0d4ff; } /* Proveedor Asignado */
		.estado-3 { background-color: #b0f0ff; } /* Cotización Registrada */
		.estado-4 { background-color: #b0ffb3; } /* Cotización Aprobada */
		.estado-5 { background-color: #ffb0b0; } /* Cotización Rechazada */
		.estado-6 { background-color: #b0ffeb; } /* OC Confirmada */
		.estado-7 { background-color: #d3d3d3; } /* Sustento Ingresado */
		.estado-8 { background-color: #e0d0d0; } /* Aviso cerrado */
								...
								<div class="ms-1 ms-lg-6">
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold w-300px" data-kt-menu="true">
										...
										<div class="row row-cols-2 g-0">
											<a href="MantenimientoAvisos.aspx" class="border-bottom border-end text-center py-10 btn btn-active-color-primary rounded-0">
												<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
								...
								<form class="form d-flex justify-content-center" runat="server">
													...
													<%--Inicio Cuerpo documento--%>
													 <div class="container my-3">
														...
														<%--Listado de Avisos--%>								 
														 ...
														 <asp:GridView ID="grvlistaavisos" runat="server" AutoGenerateColumns="False" 
															...
															<Columns>
																...
																<asp:TemplateField HeaderText="Acción">
																				...
																				<ItemTemplate>
																					<asp:LinkButton ID="btnSeleccionar" runat="server" CommandName="TrabajarAviso"
																						CommandArgument='<%# Bind("id_aviso") %>'
																...
																<asp:TemplateField HeaderText="Nro. Aviso">
																				<HeaderStyle CssClass="fw-bold fs-6 text-center border-bottom border-2" />
																				<ItemStyle CssClass="text-center" />
																				<ItemTemplate>
																					<asp:Label ID="lblnro_aviso" runat="server" 
																						Text='<%# Bind("nro_aviso") %>' 
																						CssClass="text-dark fw-semibold form-control-sm" />
																				</ItemTemplate>
																</asp:TemplateField>

																<asp:TemplateField HeaderText="Título del Aviso">
																<HeaderStyle CssClass="fw-bold fs-6 text-center border-bottom border-2" />
																<ItemStyle CssClass="text-center" />
																<ItemTemplate>
																				<asp:Label ID="lbltitulo_aviso" runat="server" Text='<%# Bind("titulo_aviso") %>' 
																					CssClass="text-dark fw-semibold form-control-sm" />
																</ItemTemplate>
																</asp:TemplateField>
																...
																<asp:TemplateField HeaderText="Fecha de Registro">
																				...
																				<ItemTemplate>
																						<asp:Label ID="lblfec_reg_aviso" runat="server" Text='<%# Bind("fec_reg_aviso") %>' 
																										CssClass="text-dark fw-semibold form-control-sm" />
																				</ItemTemplate>
																</asp:TemplateField>
																...
																<ItemStyle CssClass="text-center" />
																<ItemTemplate>
																				<asp:Label ID="lbldesc_prioridad_aviso" runat="server" Text='<%# Bind("desc_prioridad_aviso") %>' 
																					CssClass="text-dark fw-semibold form-control-sm" />
																</ItemTemplate>
																</asp:TemplateField>
																...
																<ItemStyle CssClass="text-center" />
																<ItemTemplate>
																			<asp:Label ID="lblid_estado" runat="server" Text='<%# Bind("id_estado") %>' 
																			CssClass="text-dark fw-semibold form-control-sm" Visible="False" />
																				<asp:Label ID="lbldesc_estado" runat="server" Text='<%# Bind("desc_estado") %>' 
																					CssClass="text-dark fw-semibold form-control-sm" Visible="True" />

																	<asp:Label ID="lblIcono" runat="server" Visible="False" />
																...
																<%--<asp:TemplateField HeaderText="Imagen">
																	...
																	<ItemTemplate>
																		<asp:ImageButton 
																			ID="btnVerImagen" 
																			runat="server" 
																			CommandName="VerImagen" 
																			CommandArgument='<%# Eval("nombre_archivo") %>' 
																			ImageUrl="~/images/images_sistema/Foto.png" 
																			ToolTip="Ver imagen" 
														 ...
														 <%--<div class="row">--%>
															 <%--<div class="col-lg-12">--%>
																<%--<h3>Detalles del Aviso (Post-It)</h3>--%>
																<asp:ListView ID="lvAvisosDetalle" runat="server" ItemPlaceholderID="itemPlaceholder" Style="display:none" Visible="False">
																	<LayoutTemplate>
																		<div class="d-flex flex-wrap gap-4" id="tableroPostIt">
																			<asp:PlaceHolder ID="itemPlaceholder" runat="server"></asp:PlaceHolder>
																		</div>
																	</LayoutTemplate>
																	<ItemTemplate>
																		<div class='postit-item <%# "estado-" & Eval("id_estado") %> p-3 shadow-sm rounded' style="width:250px;">
																			<div class="d-flex justify-content-between align-items-center mb-2">
																				<span class="badge bg-primary"><%# Eval("nro_aviso") %></span>
																				<span class="fs-4">
																					<%# GetEstadoIcono(Eval("id_estado"), Eval("desc_estado")) %>
																				</span>
																			</div>

																			<h6 class="fw-bold mb-1"><%# Eval("titulo_aviso") %></h6>
																			<p><strong>Prioridad:</strong> <%# Eval("desc_prioridad_aviso") %></p>
																			<p><strong>Fecha:</strong> <%# Eval("fec_reg_aviso") %></p>

																			<div class="text-end mt-2">
																				<asp:LinkButton ID="btnSeleccionarDetalle" runat="server" 
																					CommandName="SeleccionarAviso" 
																					CommandArgument='<%# Eval("id_aviso") %>' 
																					CssClass="btn btn-outline-primary btn-sm">
																					<i class="bi bi-check-circle"></i> Abrir
																				</asp:LinkButton>
																			</div>
																		</div>
																	</ItemTemplate>
														...
														<div style="position: fixed; bottom: 15px; right: 15px; z-index: 1050;" 
															...
															<asp:LinkButton ID="btnmain" runat="server" 
																CssClass="btn-float d-flex align-items-center px-3 py-2 rounded-pill text-dark" PostBackUrl="~/main.aspx">
																<i class="fas fa-home me-2"></i>
																<span>Menú principal</span>
															</asp:LinkButton>

															<!-- Botón Registrar -->
															<asp:Panel ID="PnlBotonBusqueda" runat="server" Visible="True">
																<asp:LinkButton ID="btnbusqueda" runat="server" 
																	CssClass="btn-float d-flex align-items-center px-3 py-2 rounded-pill text-dark">
																	<i class="fas fa-save me-2"></i>
																	<span>Búsqueda de avisos</span>
																</asp:LinkButton>
															</asp:Panel>
									...
									<div class="modal-dialog">
											...
											<h5 class="modal-title text-white fw-bold text-center">
															<i class="bi bi-search me-2"></i> Búsqueda de Avisos
											</h5>
												...
												<ContentTemplate>
													...
													<asp:Panel ID="Panel3" runat="server">
														<div class="row g-3 mt-1">
															<div class="col-md-12">
																	<div class="form-floating">
																			<asp:DropDownList ID="cbounidad_usuario_aviso" runat="server" CssClass="form-select form-select-sm"></asp:DropDownList>
														...
														<div class="row g-3 mt-1">
															<div class="col-md-12">
																<div class="form-floating">
																	<asp:TextBox ID="txtnro_aviso" runat="server" CssClass="form-control form-control-sm"></asp:TextBox>
																	<label for="txtnro_aviso" class="form-label fw-semibold fs-6">Nro. Aviso</label>
																</div>
															</div>
														</div>
														<div class="row g-3 mt-1">
															<div class="col-md-12">
																<div class="form-floating">
																	<asp:DropDownList ID="cboestado_aviso" runat="server" CssClass="form-select form-select-sm"></asp:DropDownList>
																	<label for="cboestado_aviso" class="form-label fw-semibold fs-6">Estado</label>
																</div>
															</div>
														</div>
														...
														<div class="row g-3 mt-1">
															<div class="col-md-12">
																<div class="form-floating">
																	<asp:DropDownList ID="cboarea_solic_aviso" runat="server" CssClass="form-select form-select-sm"></asp:DropDownList>
														...
														<div class="row g-3 mt-1">
															<div class="col-md-12">
																<div class="form-floating">
																	<asp:DropDownList ID="cbodiagnostico_ini_aviso" runat="server" CssClass="form-select form-select-sm"></asp:DropDownList>
														...
														<div class="row g-3 mt-1">
															<div class="col-md-12">
																<div class="form-floating">
																	<asp:DropDownList ID="cboclase_aviso" runat="server" CssClass="form-select form-select-sm" AutoPostBack="True"></asp:DropDownList>
														...
														<div class="row g-3 mt-1">
															<div class="col-md-12">
																<div class="form-floating">
																	<asp:DropDownList ID="cboimpacto_aviso" runat="server" CssClass="form-select form-select-sm" AutoPostBack="True"></asp:DropDownList>
														...
														<div class="row g-3 mt-1">
															<div class="col-md-12">
																<div class="form-floating">
																	<asp:DropDownList ID="cboprioridad_aviso" runat="server" CssClass="form-select form-select-sm" AutoPostBack="True"></asp:DropDownList>
																	<label for="cboprioridad_aviso" class="form-label fw-semibold fs-6">prioridad</label>
																</div>
															</div>
														</div>
														...
														<div class="row g-3 mt-1">
															<div class="col-md-6">
																<div class="form-floating">
																	<asp:TextBox ID="txtfecregini_aviso" runat="server" CssClass="form-control form-control-sm" type="date"></asp:TextBox>
																	<label for="txtfecregini_aviso" class="form-label fw-semibold fs-6">Fecha Registro Inicio</label>

																</div>
															</div>
															<div class="col-md-6">
																<div class="form-floating">
																	<asp:TextBox ID="txtfecregfin_aviso" runat="server" CssClass="form-control form-control-sm" type="date"></asp:TextBox>
																	<label for="txtfecregfin_aviso" class="form-label fw-semibold fs-6">Fecha Registro Fin</label>
																</div>
															</div>
											...
											<div class="modal-footer d-flex justify-content-end align-items-center gap-2 border-0 pt-3 pb-4">
															...
															<!-- Botón Buscar -->
															<asp:LinkButton ID="BtnBuscarAvisos" runat="server" 
										...
										<div class="modal fade" tabindex="-1" id="myModal_busqueda_equipos_bk" role="dialog" data-backdrop="static" data-keyboard="false">    
<div class="modal-dialog">
								<div class="modal-content">
								<%--<div class="modal-header">
									<h5 class="modal-title" style="color: #FFFFFF">Búsqueda de Equipos</h5>
									
								</div>--%>
									<div class="modal-header flex-column align-items-center">
										<div class="d-flex align-items-center gap-2">
											<i class="bi bi-search fs-3 text-primary"></i>
											<h5 class="modal-title mb-0">Búsqueda de Equipos</h5>
										</div>
										<small class="text-muted">Filtra y encuentra registros fácilmente</small>
								...
								<div class="modal-footer d-flex justify-content-end align-items-center gap-2 py-1">
										...
										<div class="row g-3" style="overflow: auto">
														...
														<ContentTemplate>
															...
															<Columns>
																			...
																			<%-- <asp:TemplateField HeaderText="Cod. Equipo">
																				<HeaderStyle CssClass="fw-bold fs-6 text-center border-bottom border-2" />
																				<ItemStyle CssClass="text-center" />
																				<ItemTemplate>
																					<asp:Label ID="lblcodigo_equipo_FB" runat="server" Text='<%# Bind("codigo_equipo") %>' 
																						CssClass="text-dark fw-semibold" />
											...
											<div class="modal-dialog modal-fullscreen">
												<div class="modal-content shadow-lg rounded-3">
													...
													<div class="modal-header border-0 pb-0">
														<h5 class="modal-title fw-bold fs-4" style="color: #540f4a">
															Cotización #000000001
														</h5>
															...
															<div class="row g-3">
																<div class="col-md-4">
																	<div class="p-3 bg-light rounded shadow-sm h-100">
																		...
																		<h6 class="mb-0 fw-semibold">ACME S.A.C.</h6>
																	</div>
																</div>
																<div class="col-md-4">
																	<div class="p-3 bg-light rounded shadow-sm h-100">
																		<p class="mb-1 text-muted small">Fecha</p>
																		<h6 class="mb-0 fw-semibold">27/08/2025</h6>
																	</div>
																</div>
																<div class="col-md-4">
																	<div class="p-3 bg-light rounded shadow-sm h-100">
																		<p class="mb-1 text-muted small">Moneda</p>
																		<h6 class="mb-0 fw-semibold">USD</h6>
																	</div>
																</div>
															</div>
														</div>
														...
														<div class="table-responsive">
															<table class="table table-hover align-middle border">
																...
																<tbody>
																	<tr>
																		<td>1</td>
																		<td>Licencia de Software Premium</td>
																		<td>2</td>
																		<td>$150.00</td>
																		<td>$300.00</td>
																	</tr>
																	<tr>
																		<td>2</td>
																		<td>Servicio de Consultoría (x horas)</td>
																		<td>10</td>
																		<td>$50.00</td>
																		<td>$500.00</td>
																	</tr>
...
<!-- Modal Imagen Mejorado (cabecera delgada) -->
<div class="modal fade" id="myModal_Foto" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content border-0 shadow-lg rounded-lg">
            ...
            <div class="modal-header bg-dark text-white py-2 px-3 d-flex align-items-center justify-content-between">
                <h6 class="modal-title mb-0">
                    <i class="fas fa-image mr-2"></i> Vista Previa
                </h6>
               <%-- <button type="button" class="close text-white m-0 p-0" data-dismiss="modal" aria-label="Close" style="font-size:1.4rem;">
            ...
            <div class="modal-body bg-light text-center p-3">
                <asp:Image ID="imgPopup" runat="server"
                    CssClass="img-fluid rounded shadow border border-2 border-secondary"
            ...
            <div class="modal-footer bg-white py-2 px-3 d-flex justify-content-between align-items-center">
                ...
                <button type="button" class="btn btn-outline-dark btn-sm px-3" data-dismiss="modal">
										...
										<div class="modal fade" tabindex="-1" id="myModal_Mensaje_confirmacion">
												<div class="modal-dialog modal-md">
													<div class="modal-content text-center p-4 bg-white">
														...
														<!-- Título -->
														<h5 class="modal-title mb-2">Proceso Correctamente</h5>
