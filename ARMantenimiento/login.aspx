<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="login.aspx.vb" Inherits="ARMantenimiento.login" %>
	...
	<body id="kt_body" style="background-color: #FFFFFF">
		...
		<div class="d-flex flex-column flex-root" >
			...
			<div class="d-flex flex-column flex-lg-row flex-column-fluid" id="kt_login">
				<!--begin::Aside-->
				<div class="d-flex flex-column flex-lg-row-auto w-lg-600px pt-15 pt-lg-0" style="background: linear-gradient(to right, #540f4a, #975a89);">
					<!--begin::Aside Top-->
					<div class="d-flex flex-row-fluid flex-center flex-column-auto flex-column text-center mb-5">
						<br />
						<img alt="Logo" src="images/images_sistema/logo_acurio.png" class="h-75px h-lg-50px" />
						<br />
						<br />
						<br />
						<br />
						...
						<%--<a href="dist/index.html" class="mb-6">--%>
							<%--<img alt="Logo" src="theme/dist/assets/media/logos/logo-default.svg" class="h-50px h-lg-75px" />--%>
							<img alt="Logo" src="images/images_sistema/LogoARManto.png" class="h-225px h-lg-200px" />
						<%--</a>--%>
						<!--end::Aside Logo-->
						<!--begin::Aside Subtitle-->
						<%--<h6 class="fw-bolder fs-2x text-white lh-sm">Sorprende con un reconocimiento</h6>--%>
						<%--<asp:Label ID="Label1" runat="server" Text="Sorprende con un reconocimiento" Font-Size="20" ForeColor="White"></asp:Label>--%>
						<!--end::Aside Subtitle-->
					</div>
					<!--end::Aside Top-->
					<!--begin::Illustration-->
					<%--<div class="d-flex flex-row-auto bgi-no-repeat bgi-position-x-center bgi-size-contain bgi-position-y-bottom min-h-100px min-h-lg-350px" style="background-image: url(theme/dist/assets/media/illustrations/sigma-1/2.png"></div>--%>
					<div class="d-flex flex-row-auto bgi-no-repeat bgi-position-x-center bgi-size-contain bgi-position-y-bottom min-h-100px min-h-lg-350px" style="background-image: url(images/images_sistema/login_personas.png"></div>
					<!--end::Illustration-->
				</div>
				<!--begin::Aside-->
				<!--begin::Content-->
					...
					<div class="d-flex flex-column-fluid flex-center py-10">
						...
						<form class="form w-100"  id="form_login" runat="server">
							...
							<div class="fv-row mb-10">
								...
								<asp:TextBox ID="txtusuario" runat="server" name="username"  class="form-control form-control-lg form-control-solid"></asp:TextBox>
							...
							<div class="fv-row mb-10">
								...
								<asp:TextBox ID="txtcontraseña" runat="server" name="password"  class="form-control form-control-lg form-control-solid" TextMode="Password"></asp:TextBox>
								<%--<input class="form-control form-control-lg form-control-solid" type="password" name="password" autocomplete="off" />--%>
							</div>

							<div class="pb-lg-0 pb-5">
								<%--<div class="g-recaptcha" data-sitekey="6LfXL70pAAAAAK0yMnaLkwOVe3vgjMMfGO12oMT9"></div>--%>
							...
							<div class="pb-lg-0 pb-5">
								...
								<asp:Button ID="btnLogin" runat="server" Text="Ingresa" class="btn btn-bg-secondary" />
