<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Registro_aviso_bkp.aspx.vb" Inherits="ARMantenimiento.Registro_aviso_bkp" %>
...
<html lang="en">
	...
	<head>
		...
		<meta charset="utf-8" />
		<meta name="description" content="Área de Solución de Negocios - Sistema Web de Mantenimiento en Acurio Restaurantes." />
													...
													<div class="menu-sub menu-fit menu-sub-accordion show pb-10">
															<div class="menu-item">
																<a class="menu-link py-2 text-dark fw-normal" href="Registro_aviso.aspx" 
																   style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 14px;">
																	<span class="menu-title">Mantenimiento Aviso</span>
																</a>
															</div>
															<div class="menu-item">
																<a class="menu-link py-2 text-dark fw-normal" href="main.aspx" 
...
<%--												<div class="menu-item">
											...
											<div class="card-body fs-6 py-15 px-4 px-lg-5 text-gray-700">
												<div class="container">
													...
													<%--	 <br />--%>
														...
														<%--<h3 class="text-dark fw-bolder my-1 fs-2">Aviso Nro: 00000000</h3>--%>
															...
															<div class="col-lg-12">
																...
																<div class="tab-content border border-top-0 p-3 rounded-bottom shadow-sm bg-white" id="myTabContent">
																  ...
																  <div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="tab1-tab">
																	  ...
																	  <%--Detalle cabecera del aviso--%>

																	  <%--<div class="p-4 bg-white shadow-sm rounded-3 border border-light">
																		  <!-- Encabezado -->
																		  <div class="d-flex justify-content-between align-items-center mb-4">
																			<h5 class="fw-bold text-primary mb-0">
																			  <i class="bi bi-clipboard-data me-2"></i> Aviso Nro. <span class="text-dark">12345</span>
																			</h5>
																			<span class="badge bg-success rounded-pill px-3 py-2 fs-6">Activo</span>
																		  </div>
																		  ...
																		  <div class="row gy-3 gx-4" style="font-size: 0.95rem;">
																			<div class="col-md-6 d-flex">
																			  ...
																			  <div>
																				<div class="fw-semibold">Fecha de registro</div>
																				<div class="text-muted">28/08/2025</div>
																			  </div>
																			</div>
																			<div class="col-md-6 d-flex">
																			  <i class="bi bi-person-circle text-primary me-2 fs-5"></i>
																			  <div>
																				<div class="fw-semibold">Usuario de registro</div>
																				<div class="text-muted">IvanMartinez</div>
																			  </div>
																			</div>
																			<div class="col-md-6 d-flex">
																			  ...
																			  <div>
																				...
																				<div class="text-muted">28/08/2025 19:45</div>
																			  </div>
																			</div>
																		  </div>
																		</div>--%>
																	 ...
																	 <%-- <div class="p-4 bg-white shadow-sm rounded-3 border border-light">
																		  <!-- Encabezado -->
																		  <div class="d-flex justify-content-between align-items-center mb-4">
																			<h4 class="fw-bold mb-0" style="color:#540f4a;">
																			  <i class="" style="color:#540f4a;"></i>
																			  Aviso Nro. <span class="text-dark">AV000001</span>
																			</h4>
																												
																		  </div>

																		  <!-- Detalles -->
																		  <div class="row gy-3 gx-4" style="font-size: 1rem;">
																			<div class="col-md-6 d-flex">
																			  <i class="" style="color:#540f4a;"></i>
																			  <div>
																				<div class="fw-semibold">Fecha de registro</div>
																	 ...
																	 <%-- <div class="p-3 bg-white shadow rounded-3" style="font-size: 0.85rem;">
																		  <h6 class="fw-bold mb-3 text-center">Aviso Nro.</h6>
																	  </div>--%>
																	  <br />
																	  <%--Linea tiempo--%>
																	...
																	<!-- Contenedor de línea de tiempo horizontal -->
																		<div class="p-3 bg-white shadow rounded-3" style="font-size: 0.85rem;">
																			...
																			<div class="d-flex justify-content-center align-items-center mb-4">
																				<h4 class="fw-bold mb-0" style="color:#540f4a;">
																					<i class="bi bi-clipboard-data me-2" style="color:#540f4a;"></i>
																					Aviso Nro. <span class="text-dark">AV000001</span>
																				</h4>
																			</div>

																			 <%--<h6 class="fw-bold mb-3 text-center">Estados del Aviso</h6>--%>
																			<br />
																			<br />
																			 <div class="timeline-horizontal d-flex justify-content-between align-items-center">
																	  ...
																	  <div class="card-body p-3">
																		<%--<h6 class="mb-3 fw-semibold fs-5" style="color: #860264"></h6>--%>
																		<%--  <br />--%>
																		<div class="row g-3">
																			<div class="col-md-6">
																				<div class="form-floating">
																					<asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-select form-select-sm"></asp:DropDownList>
																					<label for="DropDownList3" class="form-label fw-semibold fs-6">Unidad</label>
																				</div>
																			</div>
																			<div class="col-md-6">
																				<div class="form-floating">
																					<asp:TextBox ID="TextBox2" runat="server" CssClass="form-control form-control-sm"></asp:TextBox>
																					<label for="TextBox1" class="form-label fw-semibold fs-6">Título del Aviso</label>
																				</div>
																			</div>
																		</div>
																		...
																		<div class="row g-3 mt-1">
																			<div class="col-md-6">
																				...
																				<div class="form-floating">
																					...
																					<label for="TextBox1" class="form-label fw-semibold fs-6">Prioridad</label>
																				</div>
																				</div>
																			</div>
																			<div class="col-md-6">
																				<div class="form-floating">
																					<select id="DropDownListClase" class="form-select">
																						<option value="">Seleccione una opción</option>
																						<option value="1">Opción 1</option>
																						<option value="2">Opción 2</option>
																					</select>
																					<label for="DropDownListClase">Clase</label>
																				</div>
																			</div>
																		</div>
																		...
																		<div class="row g-3 mt-1">
																			<div class="col-md-6">
																				<div class="form-floating">
																					<asp:DropDownList ID="DropDownList8" runat="server" CssClass="form-select form-select-sm"></asp:DropDownList>
																					<label for="DropDownList4" class="form-label fw-semibold fs-6">Diagnóstico Inicial</label>
																				</div>
																			</div>
																			<div class="col-md-6">
																				<div class="form-floating">
																					<select id="DropDownListClasex" class="form-select">
																						<option value="">Seleccione una opción</option>
																						<option value="1">Opción 1</option>
																						<option value="2">Opción 2</option>
																					</select>
																					<label for="DropDownListClasex">Área solicitante</label>
																				</div>
																			</div>
																		</div>
																		...
																		<div class="row g-3 mt-1">
																			<div class="col-md-6">
																				<div class="form-floating">
																					...
																					<label for="DropDownList6" class="form-label fw-semibold fs-6">Impacto</label>
																				</div>
																			</div>
																			<div class="col-md-6">
																				<div class="form-floating">
																					<asp:TextBox ID="TextBox7" runat="server" CssClass="form-control form-control-sm"></asp:TextBox>
																					<label for="TextBox6" class="form-label fw-semibold fs-6">Equipo (B)</label>
																				</div>
																			</div>
																		</div>
			...
			<%--															<div class="mt-2">
																			<div class="form-floating">
																					<asp:TextBox ID="TextBox3" runat="server" TextMode="MultiLine" Rows="20" MaxLength="500" CssClass="form-control form-control-lg"></asp:TextBox>
																					<label for="TextBox6" class="form-label fw-semibold fs-6">Descripción del Aviso</label>
																		  ...
																		  <div class="mt-2 form-floating">
																				...
																				<label for="TextBox3" class="form-label fw-semibold fs-6">Descripción del Aviso</label>
																			</div>
																		...
																		<div class="row g-3 mt-1">
																			<div class="col-md-12">
																				<h6 class="fw-semibold text-secondary fs-7">Archivos Adjuntos</h6>
																				<div class="input-group input-group-sm mt-1 w-100">
																					<asp:FileUpload ID="inputGroupFile04" runat="server" CssClass="form-control form-control-sm" />
																					<asp:UpdatePanel ID="UpdatePanel1" runat="server">
																						<ContentTemplate>
																							<asp:LinkButton ID="LinkButton2" runat="server" CssClass="btn btn-outline-primary btn-sm">
																								Adjuntar
																							</asp:LinkButton>
																						</ContentTemplate>
																					</asp:UpdatePanel>
																  ...
																  <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
																		...
																		<div class="card-body p-3">
																			<div class="row g-3 mt-1">
																				<div class="col-md-6">
																					<div class="form-floating">
																							...
																							<label for="TextBox1" class="form-label fw-semibold fs-6">Ruc Proveedor (B)</label>
																					</div>
																				</div>
																				<div class="col-md-6">
																					<div class="form-floating">
																			...
																			<div class="row g-3 mt-1">
																				<div class="col-md-6">
																					<div class="form-floating">
																						<asp:DropDownList ID="DropDownList2" runat="server" CssClass="form-select form-select-sm"></asp:DropDownList>
																						<label for="DropDownList3" class="form-label fw-semibold fs-6">Clase de OTM</label>
																					</div>
																				</div>
																				<div class="col-md-6">
																					<div class="form-floating">
																						<asp:TextBox ID="TextBox6" runat="server" CssClass="form-control form-control-sm"></asp:TextBox>
																						<label for="TextBox1" class="form-label fw-semibold fs-6">Grupo de Compras (B)</label>
																					</div>
																				</div>
																			</div>
																			<div class="row g-3 mt-1">
																				<div class="col-md-6">
																					<div class="form-floating">
																						...
																						<label for="txtFechaInicio" class="form-label fw-semibold fs-6">Fecha Inicial de la Cotización</label>
																					</div>
																				</div>
																				<div class="col-md-6">
																					<div class="form-floating">
																						<asp:TextBox ID="TextBox8" runat="server" CssClass="form-control form-control-sm" TextMode="Date"></asp:TextBox>
																						<label for="txtFechaInicio" class="form-label fw-semibold fs-6">Fecha Final de la Cotización</label>
																					</div>
																				</div>
																			</div>
																			...
																			<div class="row g-3 mt-1">
																				<div class="col-md-6">
																					<div class="form-floating">
																									<asp:DropDownList ID="DropDownList3" runat="server" CssClass="form-select form-select-sm"></asp:DropDownList>
																									<label for="DropDownList3" class="form-label fw-semibold fs-6">Servicio (Familia)</label>
																					</div>
																				</div>
																				<div class="col-md-6">
																					<div class="form-floating">
																									<asp:DropDownList ID="DropDownList4" runat="server" CssClass="form-select form-select-sm"></asp:DropDownList>
																									<label for="DropDownList3" class="form-label fw-semibold fs-6">Servicio (SubFamilia)</label>
																					</div>
																				</div>
																			</div>
																						...
																						<tbody>
																							<tr>
																								...
																								<td class="text-center">
																									<button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_2">
