<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="main.aspx.vb" Inherits="ARMantenimiento.main" %>
											...
											<div class="card card-stretch overlay mb-5 shadow-none min-h-250px">
															<div class="card-body d-flex flex-column p-0">
																<div class="overlay-wrapper flex-grow-1 card-rounded 
																	...
																	<!-- Link invisible -->
																	<asp:Panel ID="pnlregistroaviso" runat="server">
																		<a href="Registro_aviso.aspx" class="stretched-link"></a>
																	</asp:Panel>
											...
											<div class="card-body d-flex flex-column p-0">
												<div class="overlay-wrapper flex-grow-1 card-rounded 
													...
													<asp:Panel ID="pnlreporte" runat="server">
														<a href="main.aspx" class="stretched-link"></a>
													</asp:Panel>
												</div>
												<div class="overlay-layer bg-white bg-opacity-25 card-rounded"></div>
											</div>
										...
										<div class="card overlay min-h-125px mb-5 shadow-none">
											<div class="card-body d-flex flex-column p-0">
												<div class="overlay-wrapper flex-grow-1 card-rounded 
													...
													<!-- Link -->
													<asp:Panel ID="pnlanalitica" runat="server">
															<a href="main.aspx" class="stretched-link"></a>
													</asp:Panel>
												</div>
												<div class="overlay-layer bg-white bg-opacity-25 card-rounded"></div>
